...
test('Passkey registration, cookie CSRF mutation, logout, and login @desktop', async ({ page, context }) => {
  ...
  await expect(page.getByText('CSRF verified peer のToken')).toBeVisible();
