...
run(process.execPath, ["--check", "infra/cloudflare/scripts/render-r2-direct-tfvars.mjs"]);
...
run(process.execPath, ["--check", "scripts/cloudflare-d1-recovery-drill.mjs"]);
run(process.execPath, ["--check", "scripts/chromium-extension-e2e.mjs"]);
run(process.execPath, ["--check", "scripts/chromium-extension-store-evidence.mjs"]);
...
run(process.execPath, ["--check", "scripts/cloudflare-web-push-e2e.mjs"]);
run(process.execPath, ["--check", "scripts/cloudflare-cron-evidence.mjs"]);
run(process.execPath, ["--check", "scripts/cloudflare-metrics-evidence.mjs"]);
run(process.execPath, ["--check", "scripts/cloudflare-load-evidence.mjs"]);
run(process.execPath, ["--check", "scripts/cloudflare-synthetic-monitor.mjs"]);
